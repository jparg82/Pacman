...
/**
 * Clase del fantasma Pinky, este fantasma sigue a pacman por el laberinto intentando
 * colisionar con el primero horizontalmente y luego verticalmente ,extiende a la clase Fantasma
 * @author Juan Paulo
 */
public class Pinky extends Fantasma {
    ...
    */
     public Pinky(Posicion pos, int ancho, int alto, int velocidad, Mapa mapa,String imagenf){
     ...
     /**
     * metodo con el movimiento especifico de pinky
     * persigeu a pacman primero horizontalmente y luego verticalmente
     * @param pacman 
     */
